...
function OpenEmbedStepWithDevtoolSample(sampleType) {
    ...
    switch (sampleType){
        case 'MSIT':
            staticReportUrl = 'https://powerbi-embed-api.azurewebsites.net/api/reports?id=bf33002e-9adc-452d-a0b5-fb649d806358&env=Msit';
            break;
        case 'DXT':
            staticReportUrl = 'https://powerbi-embed-api.azurewebsites.net/api/reports?id=e54c36f0-46eb-4d17-8121-f98e5148c8be&env=Dxt';
            break;
        case 'EDOG':
            staticReportUrl = 'https://powerbi-embed-api.azurewebsites.net/api/reports?id=f360ea1a-3d5c-4aca-a3e5-303f30c84c05&env=Edog';
            break;
    }
